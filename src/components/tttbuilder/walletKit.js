...
- FEES: every send / command broadcasts a Kaspa L1 transaction. Show the native Kaspa network fee (sompi from the kit, usually far under $0.01). Never ETH gas, never a fake "service fee". Copy: "Kaspa network fee" next to the amount on Send and on every agent command that spends.
